...
- `create_python_mail_endpoint_server()` - создание Python HTTP сервера скрипта для обработки POST запросов на отправку писем
...
- Формирование писем в формате RFC 2822
