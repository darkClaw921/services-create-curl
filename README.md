...
- ⚡ **Поддержка разных окружений** - запуск через чистый Python, UV-менеджер, Poetry, PHP-сервер
...
- Python3 и/или UV менеджер и/или Poetry и/или PHP (в зависимости от выбранного режима запуска)
